...
import { Heart, Sparkles, ShoppingBag, ArrowRight, Bell, Bookmark } from "lucide-react";
...
export function WishlistEmptyState() {
  ...
  const perks = [
    {
      icon: Bookmark,
      title: t("empty.features.curate.title"),
      description: t("empty.features.curate.description"),
    },
    {
      icon: Bell,
      title: t("empty.features.notify.title"),
      description: t("empty.features.notify.description"),
    },
    {
      icon: ShoppingBag,
      title: t("empty.features.seamless.title"),
      description: t("empty.features.seamless.description"),
    },
  ];
        ...
        <motion.div variants={badgeBoxVariants} className="relative mb-6">
          ...
          >
            <div className="flex size-14 sm:size-16 items-center justify-center rounded-2xl bg-primary-100/60 dark:bg-primary-950/70 text-primary-800 dark:text-primary-200">
              ...
              >
                <Heart className="size-7 sm:size-8 stroke-[1.4]" aria-hidden />
              </motion.div>
            </div>
          </motion.div>
