#!/usr/bin/env bash
# Deploys file-cloud on the server: pulls latest code, installs deps,
# builds the Next.js app, and (re)starts it under PM2 on port 3005.
#
...
echo "==> Done. $APP_NAME is running on port 3005."
